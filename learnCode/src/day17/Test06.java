...
public class Test06 {
    public static void main(String[] args) {
        ...
        for (int i=0; i<split.length;i++) {
            ...
            String province=split1[0].replace("'","");
            provinceMap.put(i+1,province);
            String citys = split1[1].replace("'", "").replace("[", "").replace("]", "");
            String[] cityStr = citys.split(",");
            for (String city : cityStr) {
                cityList.add(city);
            }
           listMap.put(province,cityList);

        }

        Set<Map.Entry<Integer, String>> entries = provinceMap.entrySet();
        ...
        System.out.println(listMap.get(provinceMap.get(i)));
